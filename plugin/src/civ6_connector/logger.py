...
if TYPE_CHECKING:
    from civ6_connector.telemetry import TelemetryEmitter
...
class GameLogger:
    ...
    def __init__(self, emitter: TelemetryEmitter) -> None:
        from civ6_connector.telemetry import EVENT_GAME_OVER, EVENT_TOOL_CALL
        ...
        self._agent_model: str | None = os.environ.get("CODEX_HL_CIV6_AGENT_MODEL") or None
