...
from civ6_connector.narrate import (
...
class GameState:
    ...
    async def load_save(self, save_index: int) -> str:
        ...
        import time
        from civ6_connector.game_lifecycle import load_save
    ...
    async def execute_lua(self, code: str, context: str = "gamecore") -> str:
        ...
        from civ6_connector.game_lifecycle import execute_lua
