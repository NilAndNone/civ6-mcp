...
- macOS: fully supported (process mgmt, OCR, window automation)
  Install with: uv pip install 'codex-hl-civ6[launcher-macos]'
- Windows: fully supported (process mgmt, OCR, window automation)
  Install with: uv pip install 'codex-hl-civ6[launcher-windows]'
- Linux: fully supported (process mgmt, OCR, window automation)
  Install with: uv pip install 'codex-hl-civ6[launcher-linux]'
...
def _require_gui_deps() -> None:
    ...
    if sys.platform == "linux":
        ...
        try:
            ...
            missing.append("python-mss (uv pip install 'codex-hl-civ6[launcher-linux]')")
        try:
            import pytesseract  # noqa: F401
        except ImportError:
            missing.append("pytesseract (uv pip install 'codex-hl-civ6[launcher-linux]')")
...
def _find_game_window_linux() -> WindowInfo | None:
    ...
    to avoid false positives (e.g. a browser tab showing codex-hl-civ6 docs).
