# Asset: tool_policy.t50_metrics_review

## Purpose

This tool policy defines the first Phase 3 metric comparison gate.

## Primary T50 Metrics

Phase 3 compares recorded T50 episodes using the roadmap's first metrics:
